...
const component_45stubJSAn799hjMzf5RKIHKNasD_ers7Yfx6_5pT50ybOC6g = {};
...
const _routes = [
  {
    name: "tv_shows",
    path: "/tv_shows",
    component: () => import('./tv_shows.vue.mjs')
  },
  {
    name: "favorites",
    path: "/favorites",
    component: () => import('./favorites.vue.mjs')
  },
  {
    name: "movies",
    path: "/movies",
  ...
  {
    name: "movies-movie-movie_id",
    path: "/movies/movie-:movie_id()",
    component: () => import('./movie-_movie_id_.vue.mjs')
  },
  {
    name: "people-person-person_id",
    path: "/people/person-:person_id()",
    component: () => import('./person-_person_id_.vue.mjs')
  },
  {
    name: (_a = __nuxt_page_meta) == null ? void 0 : _a.name,
    path: "/",
    component: component_45stubJSAn799hjMzf5RKIHKNasD_ers7Yfx6_5pT50ybOC6g
  }
];
...
export { _export_sfc as _, useRuntimeConfig as a, useRouter as b, useNuxtApp as c, nuxtLinkDefaults as d, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useRoute as u };
